 ...
 *
 * schema.sql
 *    Complete default schema for NeuronAgent
 *
 * This file contains the complete database schema for NeuronAgent, combining
 * all migration files into a single, comprehensive, and well-documented schema.
 * It includes all tables, indexes, functions, triggers, and related objects
 * needed for NeuronAgent to run with default configuration.
 *
 * Copyright (c) 2024-2025, neurondb, Inc. <admin@neurondb.com>
 *
 * IDENTIFICATION
 *    NeuronAgent/schema.sql
 *
 *=============================================================================
 *
 * TABLE OF CONTENTS
 ...
 * =====
 *
 * To apply this schema to a database:
 *
